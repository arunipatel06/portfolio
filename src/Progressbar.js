    ...
    <div className={classes.root}>
      <div className={classes.progresslist}>
        <div className={classes.progressclass}>
          ...
          <Bar1 className={classes.margin} variant="determinate" value={85} />
        </div>

        <div className={classes.progressclass}>
          <Typography className={classes.text}> React </Typography>
          <Bar2 className={classes.margin} variant="determinate" value={80} />
        </div>

        <div className={classes.progressclass}>
          <Typography className={classes.text}> GraphQL </Typography>
          <Bar3 className={classes.margin} variant="determinate" value={70} />
        </div>
        ...
        <div className={classes.progressclass}>
          ...
          <Bar5 className={classes.margin} variant="determinate" value={75} />
        </div>
      </div>
    </div>
  );
